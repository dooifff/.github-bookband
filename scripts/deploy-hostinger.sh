...
if [ -f "package.json" ]; then
    ...
    echo "✅ File .env frontend dibuat: VITE_API_URL=https://$DOMAIN/api/v1"
    echo ""
    npm run build
...
echo ""
echo "2️⃣  Upload Files ke public_html/:"
echo "   - deploy-hostinger/.htaccess → public_html/.htaccess"
echo "   - backend/ folder → public_html/backend/"
echo "   - web/dist/ contents → public_html/backend/public/"
echo ""
echo "   ⚠️  PENTING: File index.html dan assets/ dari web/dist/"
echo "   harus di-upload ke public_html/backend/public/"
echo ""
echo "3️⃣  Setup .env:"
echo "   - Copy .env.example ke public_html/backend/.env"
...
echo ""
echo "7️⃣  Verify:"
echo "   - Buka https://$DOMAIN/api/health"
echo "   - Buka https://$DOMAIN/backend/public/setup.php"
echo ""
...
echo ""
echo "⚠️  HAPUS file setup.php, test.php, login-test.html setelah selesai!"

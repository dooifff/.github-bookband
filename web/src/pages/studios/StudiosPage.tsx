    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="animate-fade-in-up">
          <h1 className="text-3xl font-bold text-text-primary tracking-tight">Studios</h1>
          <p className="text-text-secondary mt-1 text-sm">Manage all studios on the platform</p>
        </div>
            ...
            <table className="w-full table-luxury">
              ...
              <tbody className="divide-y divide-border/40">
                {loading ? (
                  ...
                  <tr><td colSpan={5} className="px-6 py-16 text-center text-text-muted text-sm">No studios found</td></tr>
                ) : (
                      ...
                      <td>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            {studio.is_verified && <span className="text-accent text-[0.6rem]">✓ Verified</span>}
                          </div>
                        </div>
                      </td>
